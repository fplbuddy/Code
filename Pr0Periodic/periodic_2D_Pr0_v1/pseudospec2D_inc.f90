...
!*****************************************************************
      SUBROUTINE hdcheck(a,t,ordvf,ordvh)
!-----------------------------------------------------------------
!
...
!
      ...
      DOUBLE COMPLEX, DIMENSION(n,ista:iend) :: a,c1
...
!
      ...
      CALL dubderivk2(a,c1,1)       ! psi_xx
      CALL inerprod(c1,a,-ordvf,fenk)
